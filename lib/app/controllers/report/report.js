 ...
 * @Last Modified time: 2018-06-29 12:56:19
 */
const fs = require('fs');
...
class ReportController extends Controller{
    ...
    getTable(req, res, next) {
        ...
        let config = JSON.parse(req.query.config) || {"columns": ["field","calculate", "value"]};
        let calculate = conditions.val('calculate') || false;
        if (calculate) {
            dimParten.calculate = calculate;
